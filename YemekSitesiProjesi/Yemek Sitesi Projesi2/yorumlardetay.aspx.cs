...
namespace Yemek_Sitesi_Projesi2
{
    public partial class yorumlardetay : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand komut = new SqlCommand("select YorumAdSoyad,YorumMail,Yorumicerik,Yemekid from Tbl_Yorumlar inner join Tbl_Yemekler on Tbl_Yorumlar.yemekid=Tbl_Yemekler.yemekid where Yorumid=@p1", bgl.baglanti());
